...
#            window = rg.RoseWindow([ARB NUMBER FOR WIDTH],100)
#
...
#            Draws shapes attached to window.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When the user wants to control the duration of the program run. This could be important
#            for many reasons.
#
